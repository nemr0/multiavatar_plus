...
// Static avatar data — allocated once at load, not rebuilt per call.
const _themes = {
  // Robo
  "00": {
    "A": {
...
final _sP = _buildParts();

Map<String, Map<String, String>> _buildParts() {
  const env =
  ...
  final sP = <String, Map<String, String>>{
    '00': {},
    '01': {},
    '02': {},
    '03': {},
